 ...
 * <p>
 * После замера 94,4 % этот же узкий вызов подключён к первому попаданию
 * бессрочной задачи в фокус через FocusPlannedDateService. На пути создания
 * задачи его по-прежнему нет.
 * <p>
