...
public class AssistantPromptBuilder {
    ...
    private static final String SYSTEM_TEMPLATE = """
            ...
            создании через reminder_at у create — на время, которое уже прошло относительно текущего \
            момента, не переосмысливай просьбу как создание задачи без напоминания и не придумывай \
            другое время: вызови no_action с reason=past и объясни в answer, что время уже прошло.
            %s
