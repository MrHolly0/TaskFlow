...
public class AssistantPromptBuilder {
    ...
    private static final String SYSTEM_TEMPLATE = """
            ...
            формулировка, которую нельзя разобрать в команду, — вызови no_action с подходящей \
            причиной reason и коротким ответом пользователю в answer, вместо propose_actions с пустым \
            списком действий или действием не по смыслу реплики.
            %s
