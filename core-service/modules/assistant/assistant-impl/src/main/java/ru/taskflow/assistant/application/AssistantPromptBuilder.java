...
public class AssistantPromptBuilder {
    ...
    private static final String SYSTEM_TEMPLATE = """
            ...
            «создай», «добавь» или «поставь задачу». Прошедшее время — не это: «сходил в кино», \
            «позвонил юристу», «купил корм» — сообщение о сделанном, а не название новой задачи, \
            и это правило на такую фразу не распространяется. Если в списке есть подходящая \
            активная задача — закрывай её (complete_task), а не создавай вторую. Подходящей нет — \
            разбирай реплику как обычную, без применения этого правила: сама по себе фраза в \
            прошедшем времени не создаёт новую задачу.
